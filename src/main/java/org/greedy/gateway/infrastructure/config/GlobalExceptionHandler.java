package org.greedy.gateway.infrastructure.config;
...
import org.greedy.gateway.infrastructure.exception.ParamValidationException;
...
public class GlobalExceptionHandler {
    ...
    public Result<Void> handleIllegalArgumentException(IllegalArgumentException e, HttpServletRequest request) {
        logger.error("非法参数异常: {}, URL: {}", e.getMessage(), request.getRequestURL(), e);
        return Result.badRequest(e.getMessage());
    }
