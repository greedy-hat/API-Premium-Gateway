package org.greedy.gateway.interfaces.api.request;

import jakarta.validation.constraints.NotBlank;
import org.greedy.gateway.domain.apiinstance.entity.AffinityStrength;
import org.greedy.gateway.domain.apiinstance.entity.LoadBalancingType;
...
public class SelectInstanceRequest {
    ...
    /**
     * 策略，可选
     * 默认为ROUND_ROBIN，可选：ROUND_ROBIN、LEAST_LOAD、LEAST_CONNECTION、LEAST_RESPONSE_TIME
     */
    private LoadBalancingType strategy = LoadBalancingType.SMART;
     ...
     * 亲和性过期时间（可选）
     */
    private LocalDateTime affinityExpiresAt;
    ...
    public LoadBalancingType getStrategy() {
        return strategy;
    }

    public void setStrategy(LoadBalancingType strategy) {
    ...
    public AffinityStrength getAffinityStrength() {
        return affinityStrength;
    }

    public void setAffinityStrength(AffinityStrength affinityStrength) {
        this.affinityStrength = affinityStrength;
    }

    public LocalDateTime getAffinityExpiresAt() {
        return affinityExpiresAt;
    }

    public void setAffinityExpiresAt(LocalDateTime affinityExpiresAt) {
        this.affinityExpiresAt = affinityExpiresAt;
    }
