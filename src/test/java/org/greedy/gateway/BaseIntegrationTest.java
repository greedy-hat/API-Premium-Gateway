...
import org.greedy.gateway.domain.apiinstance.entity.ApiType;
import org.greedy.gateway.domain.apiinstance.repository.ApiInstanceRepository;
import org.greedy.gateway.domain.apikey.entity.ApiKeyEntity;
import org.greedy.gateway.domain.apikey.entity.ApiKeyStatus;
import org.greedy.gateway.domain.apikey.repository.ApiKeyRepository;
import org.greedy.gateway.domain.metrics.repository.MetricsRepository;
import org.greedy.gateway.domain.project.entity.ProjectEntity;
import org.greedy.gateway.domain.project.entity.ProjectStatus;
...
public abstract class BaseIntegrationTest {
     ...
     * 创建调用结果命令的辅助方法
     */
    protected org.greedy.gateway.domain.metrics.command.CallResultCommand createCallResultCommand(
            String instanceId, boolean success, long latencyMs, 
            String errorMessage, String errorType, Map<String, Object> usageMetrics) {
        return new org.greedy.gateway.domain.metrics.command.CallResultCommand(
